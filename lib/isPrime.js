exports.isPrime = (...params) => {
  ...
  if (params.some(isNaN)) throw 'One of your parameters does not evaluate to a number';
...
// potential factors that we need to test against.
const testPrime = (num) => {
